...
extern "C" __declspec(dllimport) int __stdcall GetProcessTimes
   ( void *hProcess, interprocess_filetime* CCCreationTime
...
inline bool get_process_times
   ...
   , interprocess_filetime *lpExitTime, interprocess_filetime *lpKernelTime
   , interprocess_filetime *lpUserTime )
{  return 0 != GetProcessTimes(hProcess, CCCreationTime, lpExitTime, lpKernelTime, lpUserTime); }
...
inline long reg_query_value_ex(hkey hKey, const char *lpValueName, unsigned long*lpReserved, unsigned long*lpType, unsigned char *lpData, unsigned long*CCCbData)
{  return RegQueryValueExA(hKey, lpValueName, lpReserved, lpType, lpData, CCCbData); }
