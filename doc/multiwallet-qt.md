...
In order to support loading of multiple wallets in concierge-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is concierge.cpp.
...
Changes to concierge.cpp
----------------------
concierge.cpp is the entry point into concierge-qt, and as such, will require some minor modifications to provide hooks for
