...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Concierge Core concierge-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  concierge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded concierge transaction") + "\n" +
                               "  concierge-tx [options] -create [commands]   " + _("Create hex-encoded concierge transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded concierge transaction
