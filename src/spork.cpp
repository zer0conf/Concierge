...
// Copyright (c) 2016-2017 The Concierge developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
		...
		if (nSporkID == SPORK_17_NEW_COLLATERAL_ENFORCEMENT) r = SPORK_17_NEW_COLLATERAL_ENFORCEMENT;
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2) r = SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2_DEFAULT;
        if (nSporkID == SPORK_16_MN_WINNER_MINIMUM_AGE) r = SPORK_16_MN_WINNER_MINIMUM_AGE_DEFAULT;
		if (nSporkID == SPORK_17_NEW_COLLATERAL_ENFORCEMENT) r = SPORK_17_NEW_COLLATERAL_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
	...
	if (strName == "SPORK_17_NEW_COLLATERAL_ENFORCEMENT") return SPORK_17_NEW_COLLATERAL_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
	...
	if (id == SPORK_17_NEW_COLLATERAL_ENFORCEMENT) return "SPORK_17_NEW_COLLATERAL_ENFORCEMENT";
