...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Concierge Core"),
     ...
     * override -datadir in the concierge.conf file in the default data directory
     * (to be consistent with concierged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
